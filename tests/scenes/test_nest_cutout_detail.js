// Detailed test of nesting box cutout positioning
const coop_len = 3000;
const coop_w = 3000;
const wall_h = 2000;
...
// Visualize the cutout itself as a semi-transparent red box
// Debug values:
// nest_total_w = 972
// nest_box_x = 78
// nest_cutout_bottom_z = 290 (relative to wall base)
// Cutout absolute: Z 604-864
// Boxes absolute: Z 514-864

const DISPLAY_SCALE = 0.01;

export const scene = [
  withColor(scale(front_wall, DISPLAY_SCALE), [0.72, 0.57, 0.38]),
  withColor(scale(nesting_box_viz, DISPLAY_SCALE), [0.85, 0.75, 0.60])
];
